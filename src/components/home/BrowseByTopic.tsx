...
export default function BrowseByTopic() {
  ...
  return (
    <section
      ...
      className="py-14 sm:py-20 bg-background border-b border-border"
    >
        ...
        >
          {CATEGORIES.map(({ key, description, icon }) => (
            <Link
              ...
              data-cursor="link"
              className="group flex flex-col gap-4 p-6 bg-card border border-border rounded-[16px] min-h-[170px]
            ...
            >
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <p className="text-[11px] text-muted-foreground/70 leading-[1.55]">{description}</p>
              </div>
            </Link>
          ))}
        </div>
