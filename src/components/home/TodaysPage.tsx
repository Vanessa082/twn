          ...
          <div className="flex flex-col md:flex-row md:items-center gap-0">
            ...
            >
              <div className="w-[52px] h-[52px] bg-[#F9F9F7] border border-[#ECECEC] flex items-center justify-center rounded-[10px]">
                <svg className="h-5 w-5 text-[#6B6B6B]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5" aria-hidden="true">
            ...
            <div className="flex-1 px-8 py-7 md:py-0 md:h-[170px] md:flex md:flex-col md:justify-center border-b md:border-b-0 border-[#ECECEC]">
              <span className="text-[9px] font-sans font-bold uppercase tracking-[0.28em] text-[#9B9B9B] block mb-3" style={seq(150)}>
            ...
            {/* Right — CTA */}
            <div className="flex-shrink-0 px-8 py-6 md:py-0 md:h-[170px] md:w-[220px] md:flex md:items-center md:justify-end" style={seq(400)}>
              <Link
                href="/articles"
                data-cursor="link"
